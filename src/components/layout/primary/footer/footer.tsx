...
// const copyright_text = `<a href="https://www.webdesign-ninjas.com">Designed By </a> Shiv Srivastava`;
        ...
        <Box as="footer" sx={styles.footer}>
          <Container fluid={fluid}>
            <Text className="copyright" sx={styles.copyright}>
              {/* {RichText.render(copyright_text)} */}
              <a href="https://www.webdesign-ninjas.com">Designed By </a> Shiv
              Srivastava
            </Text>
